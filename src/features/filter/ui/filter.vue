...
<template>
  ...
  >
    ...
    <VGrid class="filter" cols="1" gap="4">
      ...
      />
      <Input
        v-model="currentFilter.recipientRegistryCode"
        :hasError="currentFilterErrors.recipientRegistryCode"
        :label="AppFilterVocabulary.recipientRegistryCode"
        :placeholder="AppCommonVocabulary.notEntered"
        size="small"
      />
      <Input
      ...
      />
      <Input
        v-model="currentFilter.recipientCardNumber"
        :hasError="currentFilterErrors.recipientCardNumber"
        :label="AppFilterVocabulary.recipientCardNumber"
        :placeholder="AppCommonVocabulary.notEntered"
        size="small"
      />
      <Input
